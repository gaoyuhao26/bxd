                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="expenseReport-cause"
                                               ...
                                               value="" placeholder="请输入报销类型" disabled/>
                                    </div>
                                    <div class="form-group col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="nextDealEm-select">报销单细节</label>
                                            <table class="table table-bordered expense-report-table" >
                                                <thead>
                                                <tr>
                                                    <th>序号</th>
                                                    <th>报销项目</th>
...
<script type="text/javascript" src="/js/admin/personalExpenseReport-operation.js"></script>
</body>
</html>