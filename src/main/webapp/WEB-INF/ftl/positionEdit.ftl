                            ...
                            <div class="card-body">
                                ...
                                <div  class="row">
                                    ...
                                    <#--<div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="create-time" name="create-time" value="" placeholder="请选择时间" />
                                        <span  class="label label-danger"></span>
                                    </div>-->
                                    <div class="form-group col-lg-12">
                                        <label for="create-time">时间选择</label>
                                        <input class="form-control js-datetimepicker" type="text" id="create-time" name="create-time" placeholder="请选择具体时间" value="" data-side-by-side="true" data-locale="zh-cn" data-format="YYYY-MM-DD HH:mm:ss">
                                    </div>
                                    <div class="form-group col-md-12">
