                            ...
                            <div class="card-body">
                                ...
                                <div  class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="dep-name" name="dep-name" value="" placeholder="请输入部门名称 （请输入3-10位中文、字母、数字）" />
                                        <span id="warnDepName" class="label label-danger"></span>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="dep-address">部门地址</label>
                                        <input type="text" class="form-control" id="dep-address" name="dep-address" value="" placeholder="请输入部门地址 （请输入3-10位中文、字母、数字）" />
                                        <span id="warnDepAddress" class="label label-danger"></span>
                                    </div>
